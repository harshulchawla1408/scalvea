/**
 * AppRoutes.tsx
 * Pure route declarations — no router wrapper.
 * Used by:
 *   - App.tsx (wrapped in <BrowserRouter> for the client)
 *   - entry-server.tsx (wrapped in <StaticRouter> for SSG pre-rendering)
 */
